...
export function preparationClarification(patient: PatientRun, c: Conversation, text: string): string | undefined {
  ...
  const physio = "Physiotherapy can help you prepare for surgery. A physiotherapist can teach exercises suitable for you. Your hospital therapy team can provide a personal exercise plan and teaching."
